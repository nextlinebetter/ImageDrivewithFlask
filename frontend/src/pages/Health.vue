<template>
  <el-card>
    <div class="title">
      <el-icon><Cpu /></el-icon><span>健康检查</span>
    </div>
    ...
    <el-descriptions v-if="parsed" :column="2" border style="margin-top: 12px">
      <el-descriptions-item label="embedding_backend_config">{{
        parsed.embedding_backend_config
      }}</el-descriptions-item>
      <el-descriptions-item label="embedding_backend_loaded">{{
        parsed.embedding_backend_loaded
      }}</el-descriptions-item>
      <el-descriptions-item label="embedding_dim">{{
